...
public class CommonMethods extends PageInitializer {
	...
	/**
	 * this method will click on check or radio button by the given list of
	 * webelement and the value
	 * 
	 ...
	 */
	public static void selectDDValue(WebElement dd, String visibleTextOrValue, int index) {
		try {
